            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  @endcan
                  <li class="nav-item mt-2">
                    <x-jet-nav-link href="{{route ('admin.outils.index')}}" class="nav-link active" :active="request()->routeIs('admin.outils.index')" >
...
<x-app-layout>
    <div class="content-wrapper" style="flex: inline-block " >
        @yield('content')
    <x-slot name="header">
        <h2 class="font-semibold text-center text-gray-800 leading-tight">
            {{ __('Gestion des outils') }}
        </h2>
    </x-slot>
    <div class="py-2">
