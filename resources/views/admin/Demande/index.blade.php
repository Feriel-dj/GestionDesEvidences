    ...
    <div class="wrapper">
        <aside class="main-sidebar sidebar-dark-primary  elevation-4"  style="position: fixed">
            ...
            <a  href="#" class="brand-link">
             ...
             <span  class="brand-text font-weight-light" align="center" style="text-align: center" > IMLN </span>
            </a>
            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item mt-2">
                    <x-jet-nav-link href="admin.Demande.index" class="nav-link active" :active="request()->routeIs('admin.Demande.index')">
                  ...
                  <li class="nav-item menu-open mt-2">
                    <x-jet-nav-link href="{{route ('admin.Gérerutilisateurs.index')}}" class="nav-link" >
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item mt-2">
                        <x-jet-nav-link href="{{route ('admin.user-permissions')}}" class="nav-link" :active="request()->routeIs('admin.user-permissions')">
                          <i class="fa fa-caret-right"></i>
            ...
            <div class="content-wrapper">
                ...
                <x-slot name="header">
                    <h2 class="font-semibold text-center text-gray-800 leading-tight">
                        {{ __("Ajouter une demande d'examen") }}
                    </h2>
                </x-slot>
            
                <div class="py-2">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="col-md-9 offset-md-1 bg-gray-500">
                          @livewire('demande')
                        </div>
